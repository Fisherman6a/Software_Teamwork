    ...
    >
      ...
      <div className="flex items-end gap-2">
        <textarea
          ...
          maxLength={10000}
          className={cn(
            'min-h-0 flex-1 resize-none border-0 bg-transparent p-0 outline-none placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-60',
            isLarge ? 'py-2 text-base leading-7 md:text-lg' : 'py-1 text-base md:text-sm',
          )}
          placeholder={
          ...
          rows={1}
        />
        {/* Attachment button, colocated with the send/stop action. */}
        {onFileSelect && (
          <button
            type="button"
