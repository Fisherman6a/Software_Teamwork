...
type AuthService interface {
	...
	GetAdminStatistics(ctx context.Context, reqCtx service.RequestContext, days int, granularity string) (service.AdminStatistics, error)
...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /internal/v1/admin/statistics", s.handleGetAdminStatistics)
